...
extern void *mono_aot_module_XamarinPluginMedia_iOS_info;
...
extern void *mono_aot_module_XamarinPluginMedia_info;
...
{
	mono_aot_register_module (mono_aot_module_XamarinPluginMedia_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_XamarinPluginMedia_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "XamarinPluginMedia.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
